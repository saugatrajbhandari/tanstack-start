 ...
 */
export function createViteHandler(router: import("./router-mode.d.ts").Router<{
    plugins?: any;
...
export function createDevServer(app: import("./app.js").App, { force, port, devtools, ws: { port: wsPort }, }: DevConfigInput): Promise<{
    listen: () => Promise<import("@vinxi/listhen").Listener>;
    close: () => Promise<void>;
    h3App: import("h3").App;
...
export type DevConfig = {
    ...
    https?: import("@vinxi/listhen").Certificate;
};
